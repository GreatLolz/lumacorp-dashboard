...
corp_item_metrics_gauge = Gauge(
    "corp_item_metrics",
    "All corp-owned blueprint item metrics",
    [
        "item_name",
        "item_id",
        "profitability",
...
async def metrics():
    ...
    for index in corp_profit_indexes:
        corp_item_metrics_gauge.labels(
            item_name=index.item_name,
            item_id=index.item_id,
            profitability=index.profit_index,
            sell_price=index.sell_price,
